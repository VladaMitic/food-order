...
const isEmtpty = (value) => value.trim() === '';
...
const Checkout = (props) => {
  ...
  const confirmHandler = (event) => {
    ...
    const enteredNameIsValid = !isEmtpty(enteredName);
    const enteredStreetIsValid = !isEmtpty(enteredStreet);
    const enteredPostalCodeIsValid = isFiveChar(enteredPostalCode);
    const enteredCityIsValid = !isEmtpty(enteredCity);
